...
<center>
    ...
    <br><br>  
    <form name="formulario"  method="POST" action="principal.php?CONTENIDO=assistControl/registrosActualizar.php">
        <table border="0">
            <tr><th>Cedula:</th><td><input type="number" name="cedulaPersona" value="<?=$cedula_a_buscar?><?=$cedulavisible?>" readonly/></td></tr>
            <tr><th>Fecha:</th><td><input type="datetime" name="fecha" placeholder="dd-mm-aaaa hh:mm:ss a" value="<?=$registro->getFecha()?>"/></td></tr>
