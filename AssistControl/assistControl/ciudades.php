...
//PAGINACION
$totalRegistros= count(Ciudad_A::getLista(null,null));
...
$lista = '';
$ciudades = Ciudad_A::getListaEnObjetos(null, $orden);
for ($i = 0; $i < count($ciudades); $i++) {
    ...
    $lista.= '<td>';
    $lista.= "<a href='principal.php?CONTENIDO=assistControl/ciudadesFormulario.php&codigo={$ciudad->getCodigo()}' title='Modificar'><img src='presentacion/imagenes/AssitControl/modificar.png'/></a>";
    $lista.= "<img src='presentacion/imagenes/AssitControl/eliminar.png' title='Eliminar' onClick=eliminar('assistControl/ciudadesActualizar.php&codigo={$ciudad->getCodigo()}'); />";
    $lista.= '</td>';
    $lista.= '</tr>';
}
?>
<h3>LISTA DE CIUDADES</h3><br/><br/>
    ...
    <table border="1">
        <tr><th>Ciudad</th><th>Departamento</th><th>Pais</th><th><a href="principal.php?CONTENIDO=assistControl/ciudadesFormulario.php" title="Adicionar"><img src="presentacion/imagenes/AssitControl/adicionar.png"/></a></th></tr>
        <?=$lista?>
    </table>
