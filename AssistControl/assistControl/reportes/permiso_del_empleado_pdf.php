...
function Footer()
{
    ...
    $this->Cell(0,7,'Sede Central: carrera. 4º # 16-180 Sector Potrerillo.  Teléfonos: (2) 7219744 - (2) 7219743','T',0,'C');
    $this->SetY(198);
    $this->Cell(0,7,'Página Web: www.iemoraosejo.edu.co   Email: luiseduardomoraosejo2011@gmail.com','',0,'C');
    $this->SetY(199.5);
