...
//PAGINACION
$totalRegistros= count(Departamento_A::getLista(null,null));
...
$lista = '';
$departamentos = Departamento_A::getListaEnObjetos(null, $orden);
for ($i = 0; $i < count($departamentos); $i++) {
    ...
    $lista.= '<td>';
    $lista.= "<a href='principal.php?CONTENIDO=assistControl/departamentosFormulario.php&codigo={$departamento->getCodigo()}' title='Modificar'><img src='presentacion/imagenes/AssitControl/modificar.png'/></a>";
    $lista.= "<img src='presentacion/imagenes/AssitControl/eliminar.png' title='Eliminar' onClick=eliminar('assistControl/departamentosActualizar.php&codigo={$departamento->getCodigo()}'); />";
    $lista.= '</td>';
    $lista.= '</tr>';
}
?>
<h3>LISTA DE DEPARTAMENTOS</h3><br/><br/>
    ...
    <table border="1">
        <tr><th>Departamento</th><th>Pais</th><th><a href="principal.php?CONTENIDO=assistControl/departamentosFormulario.php" title="Adicionar"><img src="presentacion/imagenes/AssitControl/adicionar.png"/></a></th></tr>
        <?=$lista?>
    </table>
